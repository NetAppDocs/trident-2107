...
----
+
NOTE:  If the status shows `Updating`, ensure that you resolve it before proceeding. For a list of possible status values, see link:../trident-get-started/kubernetes-deploy-operator.html[here^].
